...
function verObs(titulo, texto){
  $('modal-obs-titulo').textContent = titulo;
  $('modal-obs-corpo').textContent  = texto || '—';
...
function renderizarHistorico(lista){
  ...
  tbody.innerHTML=lista.map(h=>`
    <tr>
      ...
      <td>${_btnObs('Observação — ' + esc(h.nome_material), h.observacao)}</td>
